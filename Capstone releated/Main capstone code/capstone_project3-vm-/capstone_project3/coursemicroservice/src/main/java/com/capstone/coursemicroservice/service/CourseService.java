...
//
//        String studentServiceUrl = "http://localhost:9999/students/" + studentId + "/courses";
//
//        ResponseEntity<List> response = restTemplate.exchange(studentServiceUrl,List.class);
