...
//
//    @PostMapping("/marks")
//    public ResponseEntity<StudentAssignment> saveMarks(
...
@PostMapping("/marks")
public ResponseEntity<StudentAssignment> saveMarks(
        @RequestParam Integer studentId,@RequestParam Integer courseId, @RequestParam List<Integer> marks) {
    ...
    public ResponseEntity<List<Integer>> getStudentAssignmentMarks(
            @PathVariable Integer studentId,
            @PathVariable Integer courseId) {

        // Call the service to get the marks for the specified student and course
