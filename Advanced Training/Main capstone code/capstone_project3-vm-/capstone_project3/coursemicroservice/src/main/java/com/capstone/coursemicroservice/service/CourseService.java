...
public class  CourseService {
    ...
    public List getAllCoursesByStudentId(Integer studentId) {
        ...
        String studentServiceUrl = "http://localhost:5003/students/" + studentId + "/courses";
    ...
    public List<Course> getAllCoursesByProfessorId(Integer professorId,String bearerToken) {
        ...
        HttpEntity<String> entity = new HttpEntity<>(headers);
        String teacherServiceUrl = "http://localhost:5003/professor/" + professorId + "/courses"; // Adjust the URL as necessary
